<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="ordersList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="180">
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" type="text" icon="el-icon-refresh" v-if="scope.row.status == '0'"
                        @click="handleUpdate(scope.row)" v-hasPermi="['busi:orders:edit']">调度</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :title="title" :visible.sync="open" width="70%" append-to-body>
            ...
            <el-select v-model="carId" placeholder="请选择调度车辆">
                <el-option v-for="item in carOptions" :key="item.id" :label="item.carNum" :value="item.id">
                </el-option>
            </el-select>
...
export default {
    ...
    methods: {
        ...
        submitForm: function () {
            ...
            updateOrders(formdata).then(response => {
