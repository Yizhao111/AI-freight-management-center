        ...
        <el-table v-loading="loading" :data="ordersList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="180">
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" type="text" icon="el-icon-location" v-if="scope.row.status == '1'"
                        @click="handleUpdate(scope.row)" v-hasPermi="['busi:orders:edit']">配送</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        ...
        /** 修改按钮操作 */
        handleUpdate(row) {
            this.$confirm('是否确认配送订单号为"' + row.orderSn + '"的订单?', "警告", {
