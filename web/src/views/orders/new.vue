    ...
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAdd"
                    v-hasPermi="['busi:orders:add']">新增</el-button>
            </el-col>
            <el-col :span="1.5">
        ...
        <el-table v-loading="loading" :data="ordersList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="180">
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" type="text" icon="el-icon-refresh" v-if="scope.row.status == '0'" @click="handleUpdate(scope.row)"
                        v-hasPermi="['busi:orders:edit']">换货</el-button>
        ...
        <el-dialog :title="title" :visible.sync="open" width="70%" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="130px">
                <el-divider content-position="left">货主信息</el-divider>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="送货地址" prop="">
                            <!-- <el-input v-model="form.deliveryAddress" placeholder="请输入送货地址" /> -->
                            <SelectMap @mapForm="getMapForm"></SelectMap>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="接收人" prop="customUserId">
                            <!-- <el-input v-model="form.recipientName" placeholder="请输入接收人" /> -->
                            <el-select v-model="form.customUserId" placeholder="请选择客户" style="width:100%">
                                <el-option v-for="dict in customOptions" :key="dict.id" :label="dict.realName"
                    ...
                    <el-col :span="12">
                        <el-form-item label="送货日期" prop="deliveryDate">
                            <el-date-picker clearable size="small" v-model="form.deliveryDate" style="width:100%"
                                type="date" value-format="yyyy-MM-dd" placeholder="选择送货日期">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="送货地址" prop="deliveryDate">
                            <el-input v-model="form.deliveryAddress" placeholder="请点击地图" disabled />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="经度" prop="lng">
                            <el-input v-model="form.lng" placeholder="请点击地图" disabled />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="纬度" prop="lat">
                            <el-input v-model="form.lat" placeholder="请点击地图" disabled />
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                    ...
                    <el-col :span="24">
                        <el-table :data="tableData" style="width: 100%">
                            ...
                            <el-table-column prop="sku" label="库存数量"></el-table-column>
                            <el-table-column label="订购数量">
                                <template slot-scope="scope">
                                    <el-input v-model="scope.row.value" @change="handleValueChange(scope.row)"
