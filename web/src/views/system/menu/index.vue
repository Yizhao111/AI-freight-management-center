  ...
  <div class="app-container">
    <el-form :inline="true">
      ...
      <el-form-item>
        ...
        <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAdd" v-hasPermi="['system:menu:add']">新增
        </el-button>
      </el-form-item>
    </el-form>
    ...
    <el-table v-loading="loading" :data="menuList" row-key="menuId"
      ...
      <el-table-column prop="isVisible" label="是否可见" :formatter="formatBoolean"></el-table-column>
      <el-table-column prop="isLink" label="是否外链" :formatter="formatBoolean"></el-table-column>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="上级菜单">
              <treeselect v-model="form.parentId" :options="menuOptions" :show-count="true" placeholder="选择上级菜单" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="12">
            <el-form-item v-if="form.type " label="权限标识">
  ...
  export default {
    ...
    methods: {
      ...
      visibleFormat(row, column) {
        ...
        return this.selectDictLabel(this.visibleOptions, row.isVisible);
      },
