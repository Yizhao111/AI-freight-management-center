...
export function removeDrawingList() {
  localStorage.setItem(DRAWING_ITEMS, JSON.stringify([]))
}
...
export function removeFormConf() {
  return localStorage.removeItem(FORM_CONF)
}
