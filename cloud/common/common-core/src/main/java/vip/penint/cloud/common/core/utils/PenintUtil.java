...
import vip.penint.cloud.common.core.entity.constant.PageConstant;
 ...
 */
@Slf4j
public abstract class PenintUtil {
    ...
    public static String getCurrentUsername() {
        ...
        if (principal instanceof PenintAuthUser) {
            return ((PenintAuthUser) principal).getUsername();
        }
